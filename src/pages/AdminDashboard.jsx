            ...
            {activeTab === 'dashboard' && (
              <div>
                {loading ? (
                  ...
                  <p className="text-gray-500 text-center py-8">No dashboard data available</p>
                )}
              </div>
            )}
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          <div>
                            ...
                            <span className={`inline-flex mt-2 text-xs leading-5 font-semibold rounded-full px-2 py-1 capitalize ${
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm mt-1">
                    ...
                    <span className={`ml-2 inline-flex text-xs leading-5 font-semibold rounded-full px-2 py-1 capitalize ${
